...
/**
 * Black-box tests for NativeConcurStorageImpl focusing on public API contracts, inputs, outputs, and documented exceptions.
 * Tests from user perspective without knowledge of internal implementation.
 */
class NativeConcurStorageImplBlackBoxTest {
