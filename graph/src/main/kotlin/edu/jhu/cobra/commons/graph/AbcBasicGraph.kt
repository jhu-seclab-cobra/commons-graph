...
abstract class AbcBasicGraph<N : AbcNode, E : AbcEdge>(nType: Class<N>?) : IGraph<N, E> {
     ...
     * @throws EntityAlreadyExistException if a node with the given ID already exists.
     */
     ...
     * @throws EntityNotExistException if the node does not exist in the storage.
     */
    ...
    open fun refreshCache() {
        clearCache()
        storage.edgeIDsSequence.forEach { canID ->
